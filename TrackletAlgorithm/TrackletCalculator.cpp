...
// Wrapper function for TC_L1L2B, since Vivado HLS apparently does not like
...
#pragma HLS resource variable=innerStubs latency=2
#pragma HLS resource variable=outerStubs latency=2
#pragma HLS resource variable=stubPairs latency=2
